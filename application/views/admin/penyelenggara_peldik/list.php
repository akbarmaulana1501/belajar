        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Penyelenggara Pelatihan dan Diklat</li>
                </ol>
            </div>
            <?= $TombolCreate ?>
        </div>
...
<!-- load modal   -->
                        <?php $this->load->view('admin/penyelenggara_peldik/list_modal') ?>
...
<script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({ 
                ...
                "ajax": {
                    "url": "<?= site_url('penyelenggara_peldik/ajax_list')?>",
                    "type": "POST"
                },
...
*/
        ...
        function add() {
            ...
            $('#image-preview').hide(); 
            $('.id_penyelenggara_peldik_list').hide();            
            $('[name="addNamapenyelenggara_peldik"]').val(null);
        ...
        function save()
        {
            ...
            if(save_method == 'add') {
                    url = "<?php echo site_url('penyelenggara_peldik/insert')?>";
                } else {
                    url = "<?php echo site_url('penyelenggara_peldik/update')?>";
                }
                ...
                Swal.fire({
                  ...
                  cancelButtonText: 'Batal'
                    ...
                    if (result.value) {
                        ...
                        $.ajax ({
                            url:"<?php echo site_url('penyelenggara_peldik/delete');?>",
                            type:"POST",
                            data:"id_penyelenggara_peldik_list="+id,
                            cache:false,
                            dataType: 'json',
        ...
        function update(id_penyelenggara_peldik_list) {
            save_method = 'update';
            $('#form')[0].reset(); // reset form on modals
            $('.form-group').removeClass('has-error'); // clear error class
            $('.help-block').empty(); // clear error string
            ...
            $.ajax({
                url : "<?php echo site_url('penyelenggara_peldik/get_by_id')?>/" + id_penyelenggara_peldik_list,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
                    $('[name="id_penyelenggara_peldik_list"]').val(data.id_penyelenggara_peldik_list);
                    $('[name="addNamapenyelenggara_peldik"]').val(data.nm_penyelenggara_peldik_list);
