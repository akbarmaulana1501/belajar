    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header badge-primary">
                <h4 class="modal-title mt-0">Approve Izin</h4>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_app" parsley-trigger="change" required
                                        placeholder="" class="form-control" id="nama_app" readonly>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nik_app" parsley-trigger="change" required
                                        placeholder="" class="form-control" id="nik_app" readonly>
                                    <input type="hidden" name="idapp" id='idapp'>
                                    <input type="hidden" name="idp" id='idp'>
                                    <!-- <input type="hidden" name="lama_izin" id='lama_izin'> -->
                                    <span class="help-block text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="unit_level_app" parsley-trigger="change" required
                                        placeholder="" class="form-control" id="unit_level_app" readonly>
                                    <span class="help-block text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="unit_kerja_app" parsley-trigger="change" required
                                        placeholder="" class="form-control" id="unit_kerja_app" readonly>
                                    <span class="help-block text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="unit_organisasi_app" parsley-trigger="change" required
                                        placeholder="" class="form-control" id="unit_organisasi_app" readonly>
                                    <span class="help-block text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nm_jenis_izin" parsley-trigger="change" required
                                        placeholder="" class="form-control" id="nm_jenis_izin" readonly>
                                    <span class="help-block text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lama_izin" parsley-trigger="change" required
                                        placeholder="" class="form-control" id="lama_izin" readonly>
                                    <span class="help-block text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
...
<?php $this->load->view('admin/approval_izin/detail_approval_izin'); ?>