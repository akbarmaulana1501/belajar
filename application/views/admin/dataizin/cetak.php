				...
				<tbody>
					...
					<tr align="center" style="text-align: center";>
						<td align="center" style="text-align: center;">
							<img src="<?= $qr_approval ?>" alt="qr_code" width="80" height="80">
							<p style="margin-bottom: 0%; margin-top: 10px; text-align: center;" >
						...
						<td align="center">
							<img src="<?= $qr_code ?>" alt="qr_code" width="80" height="80">
							<p style="margin-bottom: 0%; margin-top: 10px; text-align: center;">
								<?php echo "<u>".$nama."</u>" ?>
							</p>
						</td>
			...
			<table >
				<tbody>
					<tr>
						...
						<td style="font-size: 15px;">Alasan jika tidak di setujui : </td>
					</tr>        	
