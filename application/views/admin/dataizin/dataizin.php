                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jatah_izin_app" parsley-trigger="change" required
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        placeholder="Masukkan Jatah Izin" class="form-control" id="lama_izin" readonly>
                                        <span class="help-block text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="Name">Sisa Izin<span class="text-danger">*</span></label>
                                        <input type="text" name="jatah_izin_app" parsley-trigger="change" required
                                        placeholder="Masukkan Jatah Izin" class="form-control" id="jatah_izin_app" readonly>
                                        <span class="help-block text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
...
<?php $this->load->view('admin/dataizin/detail_dataizin'); ?>