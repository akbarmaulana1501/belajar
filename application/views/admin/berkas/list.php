            ...
            <div class="card-body table-responsive">
                <table id="table" class="table table-striped table-bordered dt-rsponsive nowrap" style="border-collapse:collapse;border-spacing:0;width:100%;">
                    ...
                    <tbody>
                        ...
                        <?php $this->load->view('admin/berkas/list_modal') ?>
...
*/
        ...
        function save()
        {
            ...
            if(save_method == 'add') {
                    url = "<?php echo site_url('berkas/insert')?>";
                } else {
                    url = "<?php echo site_url('berkas/update')?>";
                }
        ...
        function update(id_berkas) {
            ...
            $.ajax({
                url : "<?php echo site_url('berkas/get_by_id')?>/" + id_berkas,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
                    $('[name="id_berkas"]').val(data.id_berkas);
                    $('[name="addNamaberkas"]').val(data.nm_berkas);
