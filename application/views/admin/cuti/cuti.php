                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group lama">
                                    ...
                                    <input type="number" id="lama" name="lama" class="form-control" placeholder="Lama">
                                        <!-- <span class="input-group-append">
                                            <button type="button" 
                                                class="btn waves-effect waves-light btn-primary">hari</button>
                                        </span> -->
                                        <span class="help-block text-danger"></span>


                                </div>
                                <div class="form-group jns_cuti">
                                    <label for="Name">Jenis Cuti<span class="text-danger">*</span></label>
                                    <select name="jns_cuti" id="jns_cuti" class="form-control select2">
                                    <option value="">-</option>    
                                ...
                                <div class="form-group pelaksanaan_cuti">
                                    <label for="Name">Pelaksanaan Cuti<span class="text-danger">*</span></label>
                                    <select name="pelaksanaan_cuti" id="pelaksanaan_cuti" class="form-control select2">
                                        <option value="">-</option>
...
<div class="modal fade bs-example-modal-xl" id="modal_approve" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="catatan_app" parsley-trigger="change" required
                                        placeholder="Masukkan Catatan" class="form-control" id="catatan_app">
                                    <span class="help-block text-danger"></span>
                                </div>
                            </div>  
                        </div>
        ...
        <div class="modal-footer">
            <button type="button" id="btnSetuju" onclick="setujui()"  class="btn btn-success"><i class="fe-save"> </i>
                Setuju</button>
            <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
        </div>
    </div><!-- /.modal-dialog -->
...
<?php $this->load->view('admin/cuti/detail_cuti'); ?>