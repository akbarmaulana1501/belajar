...
<head>
  ...
  <style>
    @page { size: A4; margin-left: 2cm; margin-right: 2cm; margin-top: .5cm; } 
    h1 {
      font-weight: bold;
      font-size: 20pt;
      text-align: center;
...
<body class="A4">
  <section class="sheet padding-10mm">
    <br><br>
    <?php $this->load->view('templates/includes/cetak_cuti_header') ?>
    ...
    <table style="padding-top: 15px;"  >
     <tbody>
      <tr>
        <td colspan="4" align="center" style="font-weight: 900; font-size: 13pt"><h1>SURAT PERMOHONAN CUTI TAHUNAN</h1></td>
      </tr>
    </tbody>
  </table>
  <br>
  <table style="padding-top: 15px;">
   ...
   <tr>
    ...
    <table style="padding-top: 15px;">
      <tbody>
        ...
        <tr align="center" style="text-align: center";>
          ...
          <td align="center">
                  <!-- <img src="<?= $qr_approval ?>" alt="qr_code" width="80" height="80"><br>
                  <span style="margin-bottom: 0%; text-align: center;">
                    <?php echo "<u>".$nm_approval."</u>" ?>
                  </span> -->
                </td>
                <td align="center">
    ...
    <?php $this->load->view('templates/includes/cetak_cuti_footer') ?>
