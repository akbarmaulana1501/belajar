...
class M_cutiApp extends CI_Model{
    ...
    private function _get_datatables_query(){
        $this->db->select('pegawai_cuti.status,pegawai.id_pegawai,pegawai.nik,pegawai.nama,pegawai_cuti.tgl_pengajuan,pegawai_cuti.lama,pegawai_cuti.tgl_mulai,pegawai_cuti.tgl_akhir,pegawai_cuti.jns_cuti,pegawai_cuti.status,pegawai_cuti.keterangan,pegawai_cuti.id_pegawai_cuti');
        ...
        $this->db->join('pegawai_approval', 'pegawai_approval.pengajuan = pegawai_cuti.id_pegawai');
...
function getIdPengaju($id){
    $this->db->select('id_pegawai');
    $this->db->from('pegawai_cuti');
    $this->db->where('id_pegawai_cuti', $id);
    $query = $this->db->get();
